        ...
        embed: {
          ...
          fields: [
           ...
           },
           {
             ...
             value: `\`${client.prefix}play\`, \`${client.prefix}playlist\`, \`${client.prefix}loop\`, \`${client.prefix}leave\`, \`${client.prefix}resume\`, \`${client.prefix}pause\`, \`${client.prefix}skip\`, \`${client.prefix}queue\`, \`${client.prefix}clear\`, \`${client.prefix}volume\``
           },
           {
